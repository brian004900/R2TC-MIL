...
class SlideBase:
    ...
    def read(self, location=[0,0], size=None, scale=1.0, greyscale=False):
        ...
        '''
        print("abstract method; subclasses must override.")
        print("x,y are coordinates on the original image")
        print("w,h are width and height")
        print("scale is the downsample factor")
        print("returns an in-memory array")
