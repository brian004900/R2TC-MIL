...
if __name__ == "__main__":
    ...
    # if warm-start is needed, train a baseline model first
    baseline = PURE_MHIM(input_dim=1024, mlp_dim=512, n_classes=2, baseline='attn')
    # optional warm-start; usually better after init
    ...
    pred, loss_aux = mhim(x, i=100)  # i = epoch*len(loader)+i, current dataloader iter index
    ...
    # all_loss.backward()
    # optimizer.step()
    # call teacher EMA update after optimization
